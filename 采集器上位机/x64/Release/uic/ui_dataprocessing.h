...
"}"));
        ...
        pushButton_count->setGeometry(QRect(220, 680, 201, 81));
        QFont font2;
...
"background-color:white;"));
        ...
        label_m->setGeometry(QRect(10, 500, 149, 75));
        QFont font5;
...
"background-color:white;"));
        ...
        label_sps = new QLabel(widget);
        label_sps->setObjectName("label_sps");
        label_sps->setGeometry(QRect(10, 590, 141, 81));
        label_sps->setFont(font5);
        label_sps->setStyleSheet(QString::fromUtf8("color:rgb(0, 0, 0);"));
        lineEdit_sps = new QLineEdit(widget);
        lineEdit_sps->setObjectName("lineEdit_sps");
        lineEdit_sps->setGeometry(QRect(150, 590, 181, 81));
        lineEdit_sps->setFont(font3);
        lineEdit_sps->setStyleSheet(QString::fromUtf8("color:black;\n"
"background-color:white;"));
        comboBox_MHz_kHz_Hz = new QComboBox(widget);
        comboBox_MHz_kHz_Hz->addItem(QString());
        comboBox_MHz_kHz_Hz->addItem(QString());
        comboBox_MHz_kHz_Hz->addItem(QString());
        comboBox_MHz_kHz_Hz->setObjectName("comboBox_MHz_kHz_Hz");
        comboBox_MHz_kHz_Hz->setGeometry(QRect(320, 590, 91, 81));
        comboBox_MHz_kHz_Hz->setFont(font4);
...
"background-color:white;"));
    ...
    void retranslateUi(QWidget *DataProcessing)
    {
        ...
        label_sps->setText(QCoreApplication::translate("DataProcessing", "\351\207\207\346\240\267\351\200\237\347\216\207:", nullptr));
